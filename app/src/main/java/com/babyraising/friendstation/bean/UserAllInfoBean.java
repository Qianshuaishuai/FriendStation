...
public class UserAllInfoBean {
    ...
    public String getAlbumLast() {
        return albumLast;
    }

    public void setAlbumLast(String albumLast) {
        this.albumLast = albumLast;
    }
    ...
    public void setCertAvatar(String certAvatar) {
        this.certAvatar = certAvatar;
    }
    ...
    public UserAllCountBean getUserCount() {
        return userCount;
    }

    public void setUserCount(UserAllCountBean userCount) {
