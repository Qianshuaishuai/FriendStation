...
public class Constant {
    ...
    public static final String URL_FRIENDS_COIN_RECORD_SAVE = "friends/coinRecord/saveByType";
    public static final String URL_FRIENDS_COIN_RECORD_SAVE_BYNUM = "friends/coinRecord/saveByNum";
    public static final String URL_FRIENDS_COIN_RECORD_QUERYCOINISRICH = "friends/coinRecord/queryCoinIsRich";
